...
class Libro{
    ...
    public function __construct(public $titulo, public $autor, public $anio, public $genero, public $codigo){
    }
    
    public function gerInformacion(){
        return $this->titulo .', '. $this->autor .', '.$this->anio. ', ' . $this->genero.', '. $this->codigo. '<br>'; 
    }
}
